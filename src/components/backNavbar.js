  ...
  render() {
    this.innerHTML = `
      <header class="fixed top-0 left-0 w-full z-20 transition-transform duration-300">
        <div id="navbar" style="transition: transform 0.3s ease-in-out;" class="flex lg:max-w-5xl w-full mx-auto bg-background text-white p-4 justify-left items-center sm:h-16 h-20">
          <button id="button" href="/index.html" class="px04 cursor-pointer">

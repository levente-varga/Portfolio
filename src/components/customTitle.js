        ...
        <div class="text-textDim text-center content-center w-fit">
          ...
          ${github || youtube ? `
            <ul class="flex space-x-4 items-center mt-8 mx-auto w-fit">
              ${github ? `<li><a href="${github}" target="_blank" rel="noopener noreferrer">
                <svg class="size-8 fill-textDim hover:fill-textDim duration-250" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
              ...
              ${youtube ? `<li><a href="${youtube}" target="_blank" rel="noopener noreferrer">
                <svg class="size-8 fill-textDim hover:fill-textDim duration-250" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
